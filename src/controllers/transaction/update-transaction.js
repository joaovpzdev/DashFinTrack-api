...
import { checkIfIdIsValid, generateInvalidIdResponse, badRequest } from '../helpers/validation.js'
...
export class UpdateTransactionController {
    ...
    async execute(httpRequest) {
        try{
            ...
            const transaction = await this.updateTransactionUseCase.update(httpRequest.params.transactionId, params)
